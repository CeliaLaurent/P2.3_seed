...
void Step3<dim>::make_grid ()
{
  ...
  // Set a Neuman boundary condition on one face:
...
void Step3<dim>::assemble_system ()
{
  ...
  // Zero Dirichlet boundary condition on children of  all faces except 0 and 1:
  VectorTools::interpolate_boundary_values (dof_handler,
                                            0,
                                            ZeroFunction<dim>(),
                                            boundary_values);
  // non zero Dirichlet boundary condition on children of face 1:
  VectorTools::interpolate_boundary_values (dof_handler,
                                            2,
											ConstantFunction<dim>(0.5),
                                            boundary_values);
